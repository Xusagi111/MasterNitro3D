...
public class YodoAnalitycs : MonoBehaviour
{
    ...
    {
        Debug.Log("[Yodo1 Mas] ћежстраничное объ€вление открыто");
    }

    private void OnInterstitialAdClosedEvent()
    {
        Debug.Log("[Yodo1 Mas] ћежстраничное объ€вление закрыто");
    }

    private void OnInterstitialAdErorEvent(Yodo1U3dAdError adError)
    {
        Debug.Log("[Yodo1 Mas] ќшибка межстраничной рекламы -" + adError.ToString());
    }
    ...
    {
        Debug.Log("[Yodo1 Mas] ќбъ€вление о вознаграждении открыто");
    }
