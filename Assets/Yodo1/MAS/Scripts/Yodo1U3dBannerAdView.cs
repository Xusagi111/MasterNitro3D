...
namespace Yodo1.MAS
{
    public class Yodo1U3dBannerAdView
    {
...
#if UNITY_EDITOR
            for (int i = 0; i < BannerAdViews.Count; i++)
            {
                if (BannerAdViews[i].adSize == Yodo1U3dBannerAdSize.Banner)
                {
                    Yodo1EditorAds.ShowBannerAdsInEditor((int)BannerAdViews[i].adPosition);
                }
            }
#endif
#if !UNITY_EDITOR
        ...
        {
#if UNITY_EDITOR
            Yodo1EditorAds.HideBannerAdsInEditor();
#endif
#if !UNITY_EDITOR
        ...
        {
#if UNITY_EDITOR
            Yodo1EditorAds.DestroyBannerAdsInEditor();
#endif
