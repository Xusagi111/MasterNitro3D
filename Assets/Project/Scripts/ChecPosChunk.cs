...
public class ChecPosChunk : MonoBehaviour
{
    ...
    {
        if (other.gameObject.GetComponent<Chunk>()) //(other.gameObject.name == "Road_Straight" || other.gameObject.name == "Road_Right_Turn" )//(other.gameObject.TryGetComponent<Chunk>(out Chunk chunk))
        {
